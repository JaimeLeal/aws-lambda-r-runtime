...
./bin/Rscript -e 'chooseCRANmirror(graphics=FALSE, ind=34); install.packages(c("jsonlite","tictoc", "readxl", "forecast", "abind",  "matrixStats", "plyr", "lubridate", "foreach" ,"doSNOW",  "pbmcapply", "zoo","stringdist"))'
